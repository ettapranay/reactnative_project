      ...
      return (
        ...
        source={require('./assets/backgroundblue.png')}>
          <UserInfo>
            ...
            <Icon.Button name ="edit" backgroundColor= "./assets/backgroundblue.png" onPress={() => Rootnavigation.navigate('Edit')} size={30}></Icon.Button>
          <Icon.Button name ="delete" backgroundColor= "./assets/backgroundblue.png" onPress={() => Rootnavigation.navigate('Edit')} size={30}></Icon.Button>
